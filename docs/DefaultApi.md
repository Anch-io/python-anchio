...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    employee_schema_input = [anchio.EmployeeSchemaInput()] # List[EmployeeSchemaInput] | 

    try:
        # Bulk Update Employees
        api_response = api_instance.bulk_update_employees_api_v1_corp_employees_bulk_update_post(employee_schema_input)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    api_key_schema_input = anchio.APIKeySchemaInput() # APIKeySchemaInput | 

    try:
        # Create Api Key Integration
        api_response = api_instance.create_api_key_integration_api_v1_auth_integrations_api_key_post(api_key_schema_input)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    employee_role_schema = anchio.EmployeeRoleSchema() # EmployeeRoleSchema | 

    try:
        # Create Employee Roles
        api_response = api_instance.create_employee_roles_api_v1_corp_employee_roles_post(employee_role_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Meter Entries
        api_response = api_instance.create_meter_entries_api_v1_metering_meter_entry_post(meter_entry_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    employee_role_tool_schema = anchio.EmployeeRoleToolSchema() # EmployeeRoleToolSchema | 

    try:
        # Create Role Tools
        api_response = api_instance.create_role_tools_api_v1_corp_employee_roles_role_tools_post(employee_role_tool_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Employee Roles
        api_response = api_instance.delete_employee_roles_api_v1_corp_employee_roles_id_delete(id)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Role Tools
        api_response = api_instance.delete_role_tools_api_v1_corp_employee_roles_role_tools_id_delete(id)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    role = anchio.AnchRestApiUtilsFiltersToolAccessFilterSchemaToolaccessfilterschemaEnum1() # AnchRestApiUtilsFiltersToolAccessFilterSchemaToolaccessfilterschemaEnum1 |  (optional)
    ...
    order_in = anchio.AnchRestApiUtilsFiltersToolAccessFilterSchemaToolaccessfilterschemaEnum2() # AnchRestApiUtilsFiltersToolAccessFilterSchemaToolaccessfilterschemaEnum2 |  (optional)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tool Categories
        api_response = api_instance.get_tool_categories_api_v1_tools_categories_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tool Usage Report
        api_response = api_instance.get_tool_usage_report_api_v1_tools_tools_reports_usage_tool_id_get(tool_id)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tools
        api_response = api_instance.get_tools_api_v1_tools_get(limit=limit, offset=offset, name=name, category=category, name_contains=name_contains, company=company, category_in=category_in, hidden_date=hidden_date, is_visible=is_visible, order_in=order_in)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get User
        api_response = api_instance.get_user_api_v1_auth_me_get()
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Alerts
        api_response = api_instance.list_alerts_api_v1_metering_alerts_get(limit=limit, offset=offset, id=id, metric=metric, service=service)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Api Key Integrations
        api_response = api_instance.list_api_key_integrations_api_v1_auth_integrations_api_key_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Bank Accounts
        api_response = api_instance.list_bank_accounts_api_v1_corp_bank_accounts_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Company Roles
        api_response = api_instance.list_company_roles_api_v1_auth_company_roles_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Employee Roles
        api_response = api_instance.list_employee_roles_api_v1_corp_employee_roles_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Keys
        api_response = api_instance.list_keys_api_v1_auth_key_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Licenses
        api_response = api_instance.list_licenses_api_v1_auth_licenses_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Metered Service Metrics
        api_response = api_instance.list_metered_service_metrics_api_v1_metering_services_service_id_metrics_get(service_id, limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Metered Services
        api_response = api_instance.list_metered_services_api_v1_metering_services_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Notification Channels
        api_response = api_instance.list_notification_channels_api_v1_notifications_channels_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    company = 'company_example' # str |  (optional)
    id = 'id_example' # str |  (optional)
    status = anchio.NotificationFilterSchemaNotificationfilterschemaEnum() # NotificationFilterSchemaNotificationfilterschemaEnum |  (optional)

    try:
        # List Notifications
        api_response = api_instance.list_notifications_api_v1_notifications_get(limit=limit, offset=offset, company=company, id=id, status=status)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Oauth Integrations
        api_response = api_instance.list_oauth_integrations_api_v1_auth_integrations_oauth_get(limit=limit, offset=offset)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Role Tools
        api_response = api_instance.list_role_tools_api_v1_corp_employee_roles_role_tools_get(limit=limit, offset=offset, id=id, employee_role=employee_role, tool=tool, created_on=created_on, updated_on=updated_on)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # List Slack Channels
        api_response = api_instance.list_slack_channels_api_v1_integrations_slack_channels_get()
...
with anchio.ApiClient(configuration) as api_client:
    ...
    amount = anchio.Amount() # Amount |  (optional)
    created_on = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
    updated_on = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
    ...
    try:
        # List Transactions
        api_response = api_instance.list_transactions_api_v1_corp_transactions_get(limit=limit, offset=offset, id=id, transaction_type=transaction_type, amount=amount, created_on=created_on, updated_on=updated_on, account=account, currency=currency, merchant_name=merchant_name, pending=pending, tool=tool)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Plaid Create Token
        api_response = api_instance.plaid_create_token_api_v1_auth_plaid_create_token_get()
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    tool_access_request_schema = anchio.ToolAccessRequestSchema() # ToolAccessRequestSchema | 

    try:
        # Post Access Request
        api_response = api_instance.post_access_request_api_v1_corp_accesses_post(tool_access_request_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    employee_tool_access_request_schema = anchio.EmployeeToolAccessRequestSchema() # EmployeeToolAccessRequestSchema | 

    try:
        # Post Employee Access Request
        api_response = api_instance.post_employee_access_request_api_v1_corp_accesses_employee_post(employee_tool_access_request_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    api_instance = anchio.DefaultApi(api_client)
    provider = anchio.OAuth2Integration() # OAuth2Integration | 
    o_auth_post_authorization_url = anchio.OAuthPostAuthorizationUrl() # OAuthPostAuthorizationUrl | 

    try:
        # Post Oauth Credentials
        api_response = api_instance.post_oauth_credentials_api_v1_auth_integrations_oauth_provider_post(provider, o_auth_post_authorization_url)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Public Post Access Request
        api_response = api_instance.public_post_access_request_api_v1_corp_accesses_public_slug_post(slug, tool_access_request_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    refresh_token = anchio.RefreshToken() # RefreshToken | 

    try:
        # Refresh Token
        api_response = api_instance.refresh_token_api_v1_auth_refresh_token_post(refresh_token)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Resend Verification Email
        api_response = api_instance.resend_verification_email_api_v1_auth_resend_verification_email_get()
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    reset_password = anchio.ResetPassword() # ResetPassword | 

    try:
        # Reset Password
        api_response = api_instance.reset_password_api_v1_auth_reset_password_post(reset_password)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Alert
        api_response = api_instance.retrieve_alert_api_v1_metering_alerts_id_get(id)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Employee Roles
        api_response = api_instance.retrieve_employee_roles_api_v1_corp_employee_roles_id_get(id)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Link Token
        api_response = api_instance.retrieve_link_token_api_v1_auth_plaid_get_link_token_get()
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Metered Service
        api_response = api_instance.retrieve_metered_service_api_v1_metering_services_id_get(id)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    sign_in = anchio.SignIn() # SignIn | 

    try:
        # Sign In
        api_response = api_instance.sign_in_api_v1_auth_sign_in_post(sign_in)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Sign Out
        api_response = api_instance.sign_out_api_v1_auth_signout_get()
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    sign_in_credentials = anchio.SignInCredentials() # SignInCredentials | 

    try:
        # Signin Credentials
        api_response = api_instance.signin_credentials_api_v1_auth_signin_credentials_post(sign_in_credentials)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Signout All
        api_response = api_instance.signout_all_api_v1_auth_signout_all_get()
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Alert
        api_response = api_instance.update_alert_api_v1_metering_alerts_id_put(id, metered_alert_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Api Key Integration
        api_response = api_instance.update_api_key_integration_api_v1_auth_integrations_api_key_key_id_put(key_id, api_key_schema_input)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Channel
        api_response = api_instance.update_channel_api_v1_notifications_channels_id_put(id, notification_channel_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    company_schema_input = anchio.CompanySchemaInput() # CompanySchemaInput | 

    try:
        # Update Company
        api_response = api_instance.update_company_api_v1_auth_company_update_put(company_schema_input)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    api_instance = anchio.DefaultApi(api_client)
    employee_id = 'employee_id_example' # str | 
    employee_schema_input = anchio.EmployeeSchemaInput() # EmployeeSchemaInput | 

    try:
        # Update Employee
        api_response = api_instance.update_employee_api_v1_corp_employees_employee_id_put(employee_id, employee_schema_input)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Employee Roles
        api_response = api_instance.update_employee_roles_api_v1_corp_employee_roles_id_put(id, employee_role_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Metered Service
        api_response = api_instance.update_metered_service_api_v1_metering_services_id_put(id, metered_service_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    api_instance = anchio.DefaultApi(api_client)
    id = 'id_example' # str | 
    notification_schema = anchio.NotificationSchema() # NotificationSchema | 

    try:
        # Update Notification
        api_response = api_instance.update_notification_api_v1_notifications_id_put(id, notification_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Role Tools
        api_response = api_instance.update_role_tools_api_v1_corp_employee_roles_role_tools_id_put(id, employee_role_tool_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    user_schema = anchio.UserSchema() # UserSchema | 

    try:
        # Update User
        api_response = api_instance.update_user_api_v1_auth_me_update_put(user_schema)
...
with anchio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = anchio.DefaultApi(api_client)
    user_license_schema = anchio.UserLicenseSchema() # UserLicenseSchema | 

    try:
        # Update User License Schema
        api_response = api_instance.update_user_license_schema_api_v1_auth_license_update_put(user_license_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Company Logo
        api_response = api_instance.upload_company_logo_api_v1_auth_company_logo_post(file)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Contract
        api_response = api_instance.upload_contract_api_v1_corp_contracts_upload_post(csv_file)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Tool Access
        api_response = api_instance.upload_tool_access_api_v1_corp_accesses_upload_post(csv_file)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    update_contract_schema = anchio.UpdateContractSchema() # UpdateContractSchema | 

    try:
        # Upsert Contract
        api_response = api_instance.upsert_contract_api_v1_corp_contracts_contract_id_post(contract_id, update_contract_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    update_tool_contract_schema = anchio.UpdateToolContractSchema() # UpdateToolContractSchema | 

    try:
        # Upsert Contract Tool
        api_response = api_instance.upsert_contract_tool_api_v1_corp_contracts_tools_rel_id_post(rel_id, update_tool_contract_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    department_schema = anchio.DepartmentSchema() # DepartmentSchema | 

    try:
        # Upsert Department
        api_response = api_instance.upsert_department_api_v1_corp_departments_dept_id_post(dept_id, department_schema)
...
with anchio.ApiClient(configuration) as api_client:
    ...
    api_instance = anchio.DefaultApi(api_client)
    tool_id = 'tool_id_example' # str | 
    tool_schema = anchio.ToolSchema() # ToolSchema | 

    try:
        # Upsert Tool
        api_response = api_instance.upsert_tool_api_v1_tools_tools_tool_id_post(tool_id, tool_schema)
